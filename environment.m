...
function [stan_nast,nagroda,tablica_nagrod] = environment(stan,akcja,tablica_nagrod)
...
kara_za_odb = ((stan_nast(1) < 1)+(stan_nast(1) > xmax)+(stan_nast(2) < 1)+(stan_nast(2) > ymax))*0.5;
